...
function plot_original_and_flattened_spec_stats(cfg,cls)
    color = cfg.color;
...
%             ylim_intv_fooof = [-1 max(mean(data_2))]*2; %[-2,6]; %zeros(1,2);
            ...
            figure('color','white','position',[100 300 1200 240],'Renderer','Painters');
            j = 1;
